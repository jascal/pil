...
| 6.9b scaling rung (8GB card, int8) | gold 0.497; base fixed core 0.224 (series 0.285→0.230@2.8b — plateau holds at 500×); full-stack core_sw 0.268 @ 99.0% vs student 0.260 = 103% crystallization | pil feat/discourse-register-pil | teacher_69b.log, v5_69b_{base,full}.log |
